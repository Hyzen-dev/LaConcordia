...
export default function MediasCard(props) {
    ...
    const { title, picture } = props.mediasCard;
    ...
    return (
        <div className='mediasContainer__card'>
            ...
            <img src={picture} alt={title} className='mediasContainer__card__photo' onClick={handleClick} />

            {/* La classe de la div dépend de la valeur de la varibale "click", si vrai la valeur "active" est ajouté au nom de la classe. */}
            <div className={click ? "mediasActionsContainer active" : "mediasActionsContainer"} onClick={handleClick}>
